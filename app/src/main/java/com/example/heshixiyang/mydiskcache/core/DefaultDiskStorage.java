...
import com.example.heshixiyang.mydiskcache.binaryResource.FileBinaryResource;
import com.example.heshixiyang.mydiskcache.cacheEventAndListenner.CacheErrorLogger;
import com.example.heshixiyang.mydiskcache.fileTree.FileTree;
import com.example.heshixiyang.mydiskcache.fileTree.FileTreeVisitor;
import com.example.heshixiyang.mydiskcache.util.Clock;
import com.example.heshixiyang.mydiskcache.util.CountingOutputStream;
...
public class DefaultDiskStorage implements DiskStorage {
    ...
    /*
     * 通过分目录来解决三星的RFS问题，在本缓存版本的目录下会创建100个目录，
     * 对要插入的文件缓存key的hash值取模，以判断最后该文件缓存应该放入哪个文件夹中
     */
